(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  function useRegisterComponent(props, initFn, transferredProps, getAmapPromise) {
      ...
      const getAmapInstancePromise = vue.shallowRef();
      if (Object.prototype.toString.call(getAmapPromise) === '[object Function]') {
          getAmapInstancePromise.value = getAmapPromise();
          vue.provide(AmapPromise, getAmapInstancePromise);
      }
      else {
          getAmapInstancePromise.value = vue.inject(AmapPromise);
      }
      const amapInstanceWatcher = vue.watch(() => getAmapInstancePromise.value, newAmapInstancePromise => {
