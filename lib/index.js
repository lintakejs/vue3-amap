(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vue'), require('uppercamelcase')) :
  typeof define === 'function' && define.amd ? define(['exports', 'vue', 'uppercamelcase'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Vue3Amap = {}, global.vue, global.upperCamelCase));
}(this, (function (exports, vue, upperCamelCase) { 'use strict';

  function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

  var upperCamelCase__default = /*#__PURE__*/_interopDefaultLegacy(upperCamelCase);
  ...
  ***************************************************************************** */
  ...
  function getHandlerFun(prop, amapInstance, handlers) {
      ...
      return amapInstance[`set${upperCamelCase__default['default'](prop)}`] || amapInstance.setOptions;
  }
  ...
  function setPropWatchers(propsData, amapInstance, handlers, converters, editInfo) {
      ...
      Object.keys(propsData).forEach(prop => {
          ...
          const unWatch = vue.watch(() => propsData[prop], () => {
              propWatchFn(propsData, prop, amapInstance, handleFun, converters, editInfo);
          });
  ...
  function useRegisterComponent(props, initFn, transferredProps, amapPromise) {
      const amapInstance = vue.shallowRef(null);
      const amapComponent = vue.shallowRef(null);
      const editor = vue.shallowRef(undefined);
      const coverPropsUnWatch = vue.shallowRef([]);
      let getAmapInstancePromise;
      if (amapPromise) {
          getAmapInstancePromise = amapPromise;
          vue.provide(AmapPromise, amapPromise);
      }
      else {
          getAmapInstancePromise = vue.inject(AmapPromise);
      }
  ...
  var script$5 = vue.defineComponent({
      ...
      setup(props, { expose }) {
          ...
          const mapUid = guid();
          const pluginInstanceList = vue.shallowRef([]);
          const pluginInstanceListenerList = vue.shallowRef([]);
  ...
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    /* PROPS */
    , ["id"]), vue.renderSlot(_ctx.$slots, "default")]);
  }

  script$5.render = render;
  script$5.__file = "packages/vmap/src/index.vue";
  ...
  script$4.__file = "packages/vmap-circle/src/index.vue";
  ...
  script$3.__file = "packages/vmap-marker/src/index.vue";
  ...
  script$2.__file = "packages/vmap-polygon/src/index.vue";
  ...
  script$1.__file = "packages/vmap-polyline/src/index.vue";
  ...
  exports.VMap = _VMap$5;
  exports.VMapCirCle = _VMap$4;
  exports.VMapMarker = _VMap$3;
  exports.VMapPolygon = _VMap$2;
  exports.VMapPolyline = _VMap$1;
  exports.VMapText = _VMap;
  exports.default = index;
  exports.initMapApiLoader = initMapApiLoader;
